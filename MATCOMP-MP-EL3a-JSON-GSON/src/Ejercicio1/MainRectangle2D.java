...
public class MainRectangle2D {
    ...
    private static void generarFichero(String ruta) {
        ...
        Rectangle2 b1 = new Rectangle2(3,4);
        Rectangle2 b2 = new Rectangle2(4,5);
        Rectangle2 b3 = new Rectangle2(5,6);
...
//Primero he tenido que ejcutar estos comandos para limpiar la version antigua despues de añadir un objeto:

//del /S *.class (opcional)
//javac -d . src/Ejercicio1/*.java

//Y luego ya ejecutar el comando normal: java Ejercicio1.MainRectangle2D init rectangulo.json